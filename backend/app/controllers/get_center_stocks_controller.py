...
from app.services import get_center_service, get_center_stocks_list_service
from app.schemas import OneEquipementFromList


def get_center_stocks_controller(
    center_id: int, db: Session
) -> list[OneEquipementFromList]:
