...
export function Header({
  ...
  return (
    <header className="bg-[var(--card)]/95 backdrop-blur border-b border-[var(--border)] px-4 lg:px-6 h-14 flex lg:justify-end justify-between items-center sticky top-0 z-30 shrink-0">
      <button
        onClick={onMenuOpen}
      ...
      <div className="flex gap-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="cursor-pointer relative w-9 h-9 rounded-lg hover:bg-[var(--muted)] flex items-center justify-center"
          >
