 ...
 * d'auth côté frontend. /dashboard est accessible sans cookie.
 *
...
test("RED: /dashboard sans cookie → doit rediriger vers / (login)", async ({
  page,
  context,
}) => {
  ...
  // Tenter d'accéder à /dashboard directement sans authentification
  await page.goto("/dashboard");

  // Comportement attendu : redirection vers / (page de login)
  // Comportement actuel : reste sur /dashboard (bug — pas de garde)
